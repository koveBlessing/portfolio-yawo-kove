...
export default function Portfolio() {
  ...
  useEffect(() => {
    ...
    function animate() {
      const time = Date.now();
      drawBackground();
      strokes.forEach(stroke => stroke.draw(time));
  ...
  return (
    <>
      <Head>
        <title>Yawo Blessing KOVE - Développeur Full Stack</title>
        <meta name="description" content="Développeur Web & Mobile spécialisé en React, Next.js, TypeScript et développement d'applications SaaS" />
